...
fieldTypes.datetime = DateField;
fieldTypes.timestamp = DateField;
...
function Discover(dbCfg, cacheCfg) {
  ...
  var cache = null;
  if (cacheCfg) {
    cache = cachelib.init(cacheCfg.servers, cacheCfg.options);
  }
  else {
    cache = {
